...
mod tests {
    ...
    fn get_dart_output_path() -> Option<PathBuf> {
        std::env::var("DELI_RSTYPES_PATH").ok().map(PathBuf::from)
    }
    ...
    fn test_point_dart_generated() {
        ...
        let content = fs::read_to_string(&dart_file).expect("Failed to read point.dart");

        // Check for expected patterns
        assert!(
            content.contains("class Point"),
    ...
    fn test_message_dart_generated() {
        ...
        let content = fs::read_to_string(&dart_file).expect("Failed to read message.dart");
    ...
    fn test_matrix_dart_generated() {
        ...
        let content = fs::read_to_string(&dart_file).expect("Failed to read matrix.dart");
    ...
    fn test_color_enum_dart_generated() {
        ...
        let content = fs::read_to_string(&dart_file).expect("Failed to read color.dart");
    ...
    fn test_shape_enum_dart_generated() {
        ...
        let content = fs::read_to_string(&dart_file).expect("Failed to read shape.dart");
    ...
    fn test_marker_unit_struct_dart_generated() {
        ...
        assert!(
            content.contains("class Marker"),
            "Should contain class Marker"
        );
        assert!(
